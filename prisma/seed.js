...
async function seedCmsAndSettings(adminUserId) {
...
async function seedOrganizationStoreAndProducts(adminUserId) {
    ...
    await prisma.product.upsert({
        ...
        update: {
            ...
            price: new client_1.Prisma.Decimal('1300.00'),
            oldPrice: new client_1.Prisma.Decimal('2000.00'),
            stock: 100,
            status: 'ACTIVE',
            publicationStatus: 'PUBLISHED',
